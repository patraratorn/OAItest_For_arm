...
static meas_record_lst_t fill_DRB_UE_RSRP(__attribute__((unused)) const label_info_lst_t label,
                                         __attribute__((unused)) uint32_t gran_period_ms,
                                         cudu_ue_info_pair_t ue_info,
                                         __attribute__((unused)) const size_t ue_idx,
                                         __attribute__((unused)) e2_node_level_stats_t* node_stats)
{
  ...
  if (ue_info.ue != NULL) {
    NR_mac_stats_t *stats = &ue_info.ue->mac_stats;
    meas_record.int_val = stats->num_rsrp_meas > 0 ? stats->cumul_rsrp / stats->num_rsrp_meas : 0;
  } else {
    meas_record.int_val = 0;
  }
...
static meas_record_lst_t fill_DRB_UE_SINR(__attribute__((unused)) const label_info_lst_t label,
                                         __attribute__((unused)) uint32_t gran_period_ms,
                                         cudu_ue_info_pair_t ue_info,
                                         __attribute__((unused)) const size_t ue_idx,
                                         __attribute__((unused)) e2_node_level_stats_t* node_stats)
{
  ...
  if (ue_info.ue != NULL) {
    NR_mac_stats_t *stats = &ue_info.ue->mac_stats;
    meas_record.int_val = stats->num_sinr_meas > 0 ? stats->cumul_sinrx10 / (10 * stats->num_sinr_meas) : 0;
  } else {
    meas_record.int_val = 0;
  }
...
static meas_record_lst_t fill_DRB_UE_SNR(__attribute__((unused)) const label_info_lst_t label,
                                         __attribute__((unused)) uint32_t gran_period_ms,
                                         cudu_ue_info_pair_t ue_info,
                                         __attribute__((unused)) const size_t ue_idx,
                                         __attribute__((unused)) e2_node_level_stats_t* node_stats)
{
  ...
  if (ue_info.ue != NULL) {
    NR_UE_sched_ctrl_t *sched_ctrl = &ue_info.ue->UE_sched_ctrl;
    meas_record.real_val = nr_mac_get_snr(&sched_ctrl->pusch_pc);
  } else {
...
static meas_record_lst_t fill_DRB_UE_BeamIdx(__attribute__((unused)) const label_info_lst_t label,
                                            __attribute__((unused)) uint32_t gran_period_ms,
                                            cudu_ue_info_pair_t ue_info,
                                            __attribute__((unused)) const size_t ue_idx,
                                            __attribute__((unused)) e2_node_level_stats_t* node_stats)
...
static meas_record_lst_t fill_DRB_UE_TA(__attribute__((unused)) const label_info_lst_t label,
                                            __attribute__((unused)) uint32_t gran_period_ms,
                                            cudu_ue_info_pair_t ue_info,
                                            __attribute__((unused)) const size_t ue_idx,
                                            __attribute__((unused)) e2_node_level_stats_t* node_stats)
...
static kv_measure_t lst_measure[] = {
  ...
  {.key = "DRB.UE.SINR", .value = fill_DRB_UE_SINR },
